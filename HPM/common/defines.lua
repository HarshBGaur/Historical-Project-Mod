...
country = {
    ...
    GOLD_TO_CASH_RATE = 50, -- Amount of money generated per gold unit
    ...
    AI_SUPPORT_REFORM = 0.015, -- At least this many % needs to support a reform for the AI to take it
    ...
    RESEARCH_POINTS_ON_CONQUER_MULT = 500, -- multiplier to RP got by conquering as unciv when got enacted military reforms
    MAX_RESEARCH_POINTS = 31000, -- max RP you can store for uncivs
},
